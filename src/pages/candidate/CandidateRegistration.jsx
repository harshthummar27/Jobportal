        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            >
              ...
              <span className="font-medium">Back to Candidate Info</span>
            </Link>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg border-2 border-[#e4d9ff] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-lg font-bold text-[#1e2749] mb-2">Privacy Protected</h3>
              <p className="text-[#30343f] leading-relaxed text-sm">Your current company and personal details remain confidential</p>
            </div>
            
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg border-2 border-[#e4d9ff] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-[#e4d9ff] rounded-2xl mb-4">
                <Users className="h-6 w-6 text-[#273469]" />
              </div>
              <h3 className="text-lg font-bold text-[#1e2749] mb-2">Pre-vetted Companies</h3>
              <p className="text-[#30343f] leading-relaxed text-sm">Access to verified employers with competitive packages</p>
            </div>
            
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg border-2 border-[#e4d9ff] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-[#e4d9ff] rounded-2xl mb-4">
                <DollarSign className="h-6 w-6 text-[#273469]" />
              </div>
              <h3 className="text-lg font-bold text-[#1e2749] mb-2">Better Opportunities</h3>
              <p className="text-[#30343f] leading-relaxed text-sm">Find roles that match your skills and salary expectations</p>
            </div>
          </div>
        </div>
      </div>
