          ...
          <div className="flex items-center justify-between gap-1 sm:gap-2 md:gap-4 w-full">
            ...
            <div className="flex items-center gap-1 sm:gap-2 md:gap-4 flex-shrink-0">
              ...
              <button
                ...
                className="p-1.5 sm:p-2 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100/80 transition-all duration-200 active:scale-95 touch-manipulation"
